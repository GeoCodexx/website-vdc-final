...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-info elevation-4">
    ...
    <a href="<?= base_url('admin/dashboard'); ?>" class="brand-link">
      ...
      <span class="brand-text font-weight-light">I.E.I. Virgen del Carmen</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><?= ucfirst($userInfo['User_name'])." ".ucfirst($userInfo['User_lastname_01']); ?></a>
        </div>
      </div>
