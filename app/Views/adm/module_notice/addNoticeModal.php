<div class="modal fade addNotice" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light w-100 text-center" id="staticBackdropLabel">Nueva Noticia</h5>
                <button type="button" class="btn-close btn-close-white" id="clsModal" data-bs-dismiss="modal" aria-label="Close"></button>
                <!--<span aria-hidden="true">&times;</span>-->
                </button>
            </div>
            <div class="modal-body">
                <form action="<?= route_to('add.notice'); ?>" method="post" id="add-notice-form" autocomplete="off">
                    <?= csrf_field(); ?>
                    <div class="form-group">
                        <label for="">Título:</label>
                        <input type="text" class="form-control" id="notice-title" name="notice_title" placeholder="Ingrese el Asunto aquí">
