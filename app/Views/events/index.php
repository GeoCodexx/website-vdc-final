...
<?= $this->section('content') ?>
        ...
        <div class="container py-5">
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <h1 class="display-3 text-white animated slideInDown">Eventos</h1>
    ...
    <div class="container p-5">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 wow fadeInDown" data-wow-delay="0.8s">
            <div class="col">
                <a href="#">
            ...
            <div class="col">
                <a href="#">
                    <div class="card h-100 card-border shadow">
                        <img src="img/course-1jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                        </div>
